...
export const HostView = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-6 font-patrick text-ink">
      <div className="max-w-2xl w-full bg-white border-[3px] border-ink p-6 md:p-16 rounded-wobbly shadow-[8px_8px_0px_0px_#2d2d2d] relative hover:rotate-1 transition-transform duration-300">
        {/* Tape decoration */}
        ...
        <h1 className="text-4xl md:text-6xl font-kalam font-bold text-center mb-4 md:mb-8">Room Created!</h1>
        
        <div className="bg-[#fff9c4] border-[3px] border-ink p-5 md:p-8 rounded-wobblyMd -rotate-1 mb-6 md:mb-10 text-center flex flex-col items-center shadow-inner relative">
          <div className="absolute -left-3 -top-3 w-6 h-6 rounded-full bg-accent border-2 border-ink shadow-md"></div>
          
          <p className="text-2xl md:text-3xl font-bold mb-2 md:mb-4 font-kalam text-bluepen">Join Code:</p>
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 bg-white border-[3px] border-ink py-3 md:py-4 px-4 sm:px-8 rounded-wobbly shadow-[inset_3px_3px_0px_0px_rgba(0,0,0,0.1)] w-full sm:w-auto justify-center">
        ...
        <button 
          ...
          className="w-full bg-accent text-white border-[3px] border-ink py-3 md:py-5 text-3xl md:text-4xl font-kalam font-bold rounded-wobbly shadow-[6px_6px_0px_0px_#2d2d2d] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_#2d2d2d] active:translate-y-2 active:shadow-none disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
